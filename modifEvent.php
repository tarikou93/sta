<!-- pour vrifier si l'utilisateur est bien connecté -->
      ...
      <div class="min-height-200px">
        <!-- Default Basic Forms Start -->
    				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
    					<div class="clearfix">
    						<div class="pull-left">
    							<h4 class="text-blue">Modifier un évènement</h4>
    							<p class="mb-30 font-14">modifier les informations de l'évènement</p>
    						</div>
